            ...
            for (i, pre) in enumerate(predict):
                ...
                if self.flag == 2:
                    ...
                    if y == 8:
                        ...
                        all_frame_num = len(self.list_1)
                        acc_pre_frame_num = self.list_1.count(pre_1)
                        ...
                        '''
                        cv2.putText(apply_color_map_image, 'Average accuracy: {}%'.format(str(ave_acc)),
                                    (probability_position_x, probability_position_y + y_move),
                                    font, fontsize, (0, 241, 255), font_scale, cv2.LINE_AA)
                        '''
                '''                
                #タグ識別用プログラム
                # 1回目Noneのとき
                ...
                if self.flag == 2:
                    ...
                    if y == 6:
                        pre_1 = mode(self.list_1)
                        all_frame_num_1 = len(self.list_1)
                        acc_pre_frame_num_1 = self.list_1.count(pre_1)
                        ave_acc_1 = (acc_pre_frame_num_1 / all_frame_num_1) * 100
                        print('１つ目のタグの識別概要')
                        print('list_1 : {}\n'.format(self.list_1))
                        print('average_predict : {}\n'.format(pre_1))
                        print('all_frame_number : {}\n'.format(all_frame_num_1))
                        print('accurate_predict_frame_number : {}\n'.format(acc_pre_frame_num_1))
                        print('average_accuracy:{}%\n'.format(ave_acc_1))
                        print()
                ...
                if self.flag == 4:
                    ...
                    if y == 6:
                        ...
                        all_frame_num_2 = len(self.list_2)
                        acc_pre_frame_num_2 = self.list_2.count(pre_2)
                        ave_acc_2 = (acc_pre_frame_num_2 / all_frame_num_2) * 100
                        print('２つ目のタグの識別概要')
                        print('list_2 : {}\n'.format(self.list_2))
                        print('average_predict : {}\n'.format(pre_2))
                        print('all_frame_number : {}\n'.format(all_frame_num_2))
                        print('accurate_predict_frame_number : {}\n'.format(acc_pre_frame_num_2))
                        print('average_accuracy:{}%\n'.format(ave_acc_2))
                        print()
                ...
                if self.flag == 6:
                    ...
                    if y == 6:
                        ...
                        all_frame_num_3 = len(self.list_3)
                        acc_pre_frame_num_3 = self.list_3.count(pre_3)
                        ave_acc_3 = (acc_pre_frame_num_3 / all_frame_num_3) * 100
                        print('３つ目のタグの識別概要')
                        print('list_3 : {}\n'.format(self.list_3))
                        print('average_predict : {}\n'.format(pre_3))
                        print('all_frame_number : {}\n'.format(all_frame_num_3))
                        print('accurate_predict_frame_number : {}\n'.format(acc_pre_frame_num_3))
                        print('average_accuracy:{}%\n'.format(ave_acc_3))
                        print()
                ...
                if self.flag == 8:
                    if y != 6:
                        cv2.putText(apply_color_map_image, 'Predict tag: {}'.format(self.tag),
                                    ...
                                    font, fontsize, (0, 241, 255), font_scale, cv2.LINE_AA)
                    if y == 6:
                        pre_4 = mode(self.list_4)
                        all_frame_num_4 = len(self.list_4)
                        acc_pre_frame_num_4 = self.list_4.count(pre_4)
                        ave_acc_4 = (acc_pre_frame_num_4 / all_frame_num_4) * 100
                        print('４つ目のタグの識別概要')
                        print('list_4 : {}\n'.format(self.list_4))
                        print('average_predict : {}\n'.format(pre_4))
                        print('all_frame_number : {}\n'.format(all_frame_num_4))
                        print('accurate_predict_frame_number : {}\n'.format(acc_pre_frame_num_4))
                        print('average_accuracy:{}%\n'.format(ave_acc_4))
                        print()
                ...
                if self.flag == 10:
                    if y != 6:
                        cv2.putText(apply_color_map_image, 'Predict tag: {}'.format(self.tag),
                                    ...
                                    font, fontsize, (0, 241, 255), font_scale, cv2.LINE_AA)
                    if y == 6:
                        pre_5 = mode(self.list_5)
                        all_frame_num_5 = len(self.list_5)
                        acc_pre_frame_num_5 = self.list_5.count(pre_5)
                        ave_acc_5 = (acc_pre_frame_num_5 / all_frame_num_5) * 100
                        print('５つ目のタグの識別概要')
                        print('list_5 : {}\n'.format(self.list_5))
                        print('average_predict : {}\n'.format(pre_5))
                        print('all_frame_number : {}\n'.format(all_frame_num_5))
                        print('accurate_predict_frame_number : {}\n'.format(acc_pre_frame_num_5))
                        print('average_accuracy:{}%\n'.format(ave_acc_5))
                        print()
                ...
                if self.flag == 11:
                    ...
                    if self.tag == '24310':
                        ...
                        cv2.putText(apply_color_map_image,
                                    'Predict tag: {0} /  (Error: The tag was failed to be predicted.)'.format(self.tag),
                                    (probability_position_x, probability_position_y + y_move),
                                    font, fontsize, (0, 241, 255), font_scale, cv2.LINE_AA)
                '''
